...
- [ ] **降低游戏难度** ⚠️ **最重要**
  ...
  - 增加敌人碰撞判定范围至1.5-2倍
  - 降低敌人移动速度至当前的70%
  - **原因**: 当前难度太高，玩家很难体验到击中、连击、得分弹出等核心玩法，严重影响游戏体验和可玩性

### 高优先级 (P1) - 短期优化

- [ ] **添加连击特效**
  - 连击达到5/10/20时触发金色粒子爆炸
  - 增强"COMBO x5!"文字的视觉效果（缩放动画、发光）
  - 配合音效增强成就感
...
**更新时间**: 2026年1月3日 20:58
**当前状态**: MVP v2.0 - 90%完成，得分弹出动画系统已完成
**下一步**: 强烈建议降低游戏难度，让玩家能够体验到核心玩法
